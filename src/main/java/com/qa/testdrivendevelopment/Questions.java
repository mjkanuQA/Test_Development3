...
public class Questions {
	...
	public int[][] multiply(int arrayLength, int numOfArrays){
		...
		int[] multiply;
		multiply = new int[]{arrayLength, numOfArrays};
...
//		System.out.println(Arrays.toString(sort));
	...
	public int aPlus(int num) {
		...
		int calc1 = (aPLus * 10) + num;
		int add1 = calc1;
		
		int calc2 = (calc1 * 10) + num;
		int add2 = calc2;
			
		int calc3 = (calc2 * 10) + num;
		int add3 = calc3;
		
		int solution = num + add1 + add2 + add3;
	...
	public String oddNum(String allNums) {
		...
		int foo = Integer.parseInt(allNums);
...
//		System.out.println(foo);
	...
	public String longString(String input1, String input2) {	
		...
		String[] longString;
		longString = new String[]{input1, input2};
